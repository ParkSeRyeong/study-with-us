<template>
  <div>
    ...
    <div class="bottom_menu nanum">
      <div>
        <router-link to="/selfstudy"
          ><img class="icon" src="@/assets/images/1-1.png"
        /></router-link>
        <div class="nanum">공부</div>
      </div>
      <div>
      ...
      <div>
        <router-link to="/main"
          ><img class="icon" src="@/assets/images/3.png"
        /></router-link>
      </div>
      <div>
        <router-link to="/studygroup"
          ><img class="icon" src="@/assets/images/4.png"
        /></router-link>
      </div>
      <div>
        <router-link @click="logout()" to="/main"
